...
public interface ModuleRepository extends CrudRepository<ModuleMaster, Integer>, ModuleRepositoryCustom {
    ...
    @Query(value = "SELECT module.module_id, module.module_name,module.module_icon, module.active FROM mst_module as module INNER JOIN module_role_mapping as mrm ON mrm.module_id = module.module_id WHERE role_id =:roleId", nativeQuery = true)
