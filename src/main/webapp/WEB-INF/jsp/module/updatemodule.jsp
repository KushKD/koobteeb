...
<main class="app-content">
   <form:form method="POST" modelAttribute="moduleForm" action="${pageContext.request.contextPath}/updateModuleEntity" enctype="multipart/form-data" class="form-signin">
      ...
      <spring:bind path="moduleId">
         <div class="form-group ${status.error ? 'has-error' : ''}">
            <form:input type="text" path="moduleId" readonly="true" value="${module_to_update.moduleId}" autocomplete="off"  oncopy="return false" onpaste="return false"  class="form-control" autofocus="true"></form:input>
            <form:errors path="moduleId"></form:errors>
         </div>
      </spring:bind>
      <spring:bind path="moduleName">
         <div class="form-group ${status.error ? 'has-error' : ''}">
            <form:input type="text" path="moduleName" class="form-control" value="${module_to_update.moduleName}"  autocomplete="off"  oncopy="return false" onpaste="return false" placeholder="Module Name"></form:input>
            <form:errors path="moduleName"></form:errors>
         </div>
      </spring:bind>

 <div  id="moduleIcon" class="form-group col-lg-4">
         <label for="moduleIcon" class="form-label"> <spring:message code="form.documentry.aadhaar" text="Module Icon" /> *  </label>
        ...
        <a style="text-decoration:none;" href="${pageContext.request.contextPath}/downloadFile/${module_to_update.iconName}" target="_blank">View Uploaded Image &nbsp; ${module_to_update.iconName}</a>
        </div>
      ...
      <spring:bind path="isDeleted">
       ...
       <div class="col-lg-12">
            <button class="btn btn-lg btn-primary col-lg-4" type="submit">Save</button>
                   <a href="${pageContext.request.contextPath}/viewmodule" class="btn btn-lg btn-danger col-lg-4">Go Back</a>
