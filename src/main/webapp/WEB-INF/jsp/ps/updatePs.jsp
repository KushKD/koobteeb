...
<main class="app-content">
   <form:form method="POST" modelAttribute="pSForm" action="${pageContext.request.contextPath}/updatePs" class="form-signin">
      <h2 class="form-signin-heading">Update Police Station</h2>
      ...
      <spring:bind path="psId">
         <div class="form-group ${status.error ? 'has-error' : ''}">
            <form:input type="text" path="psId" readonly="true" autocomplete="off"  oncopy="return false" value="${ps_to_update.psId}" onpaste="return false"  class="form-control" autofocus="true"></form:input>
            <form:errors path="psId"></form:errors>
         </div>
      </spring:bind>
      <spring:bind path="psName">
         <div class="form-group ${status.error ? 'has-error' : ''}">
            <form:input type="text" path="psName" class="form-control" value="${ps_to_update.psName}" autocomplete="off"  oncopy="return false" onpaste="return false" placeholder="Police Station Name"></form:input>
