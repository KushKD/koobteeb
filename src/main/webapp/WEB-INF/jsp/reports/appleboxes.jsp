...
<main class="app-content">
	...
	<form:form method="POST" id="form" modelAttribute="reportsForm" action="${pageContext.request.contextPath}/getApplesReport" class="form-signin">
		<h2 class="form-signin-heading">Reports Apple Boxes (Form c)</h2>
