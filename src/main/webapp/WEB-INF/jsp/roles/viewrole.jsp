...
<main class="app-content">
   <div class="row" style="box-shadow: 0 0 8px 2px #888; padding:10px;">
      <div class="container">
      <h2 class="form-signin-heading">Roles Master</h2>
	...
	$('table#sampleTable').DataTable({
		...
		columns: [
...

			{
				data: 'roleId',
				render: function (data) {
					return '<div class="btn-group"><a href="${pageContext.request.contextPath}/updateRole/${"' + data + '"}" class="btn btn-primary" ;>Update</a></div>'
				}
