      ...
      <aside class="app-sidebar">
         ...
         <ul class="app-menu">
            ...
            <sec:authorize access="hasAnyAuthority('SUPER ADMIN','Bank Official')">
                                        <li class="treeview">
                                           <a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Bank Cash Transfer Request</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                                           <ul class="treeview-menu">

                                              <li><a class="treeview-item" href="${pageContext.request.contextPath}/createtransfer"><i class="icon fa fa-circle-o"></i> Create Transfer Request</a></li>
                                              <li><a class="treeview-item" href="${pageContext.request.contextPath}/viewTransfer"><i class="icon fa fa-circle-o"></i> View Transfer Request</a></li>
                                           </ul>
                                        </li>
                                     </sec:authorize>
