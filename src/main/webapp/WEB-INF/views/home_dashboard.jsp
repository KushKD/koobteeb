   ...
   <div class="row">
    <sec:authorize access="hasAnyAuthority('SUPER ADMIN', 'ADMIN')">
       ...
       <sec:authorize access="hasAnyAuthority('SUPER ADMIN')">
            <div class="col-md-6 col-lg-3">
               <div class="widget-small primary coloured-icon">
                  <i class="icon fa fa-id-badge fa-3x"></i>
                  <div class="info">
                     <a href="${pageContext.request.contextPath}/approvedCardList" style=" text-decoration: none !important;">
                        <h4>View Approved Cards</h4>
                     </a>
                  </div>
               </div>
            </div>
      ...
      <sec:authorize access="hasAuthority('SUPER ADMIN')">
       ...
       <sec:authorize access="hasAnyAuthority('CASHIER','SUPER ADMIN')">
               <div class="col-md-6 col-lg-3">
                  <div class="widget-small warning coloured-icon">
